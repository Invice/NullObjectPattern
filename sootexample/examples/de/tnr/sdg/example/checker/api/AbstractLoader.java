...
package de.tnr.sdg.example.checker.api;
...
public abstract class AbstractLoader
    ...
    private final Map<Object, Object> publicIdToResourceNameMap;
    ...
    /**
     * Creates a new instance.
     * @param hashMap maps public IDs to DTD resource names
     * @throws SAXException if an error occurs
     * @throws ParserConfigurationException if an error occurs
     */
    ...
    public InputSource resolveEntity(String publicId, String systemId)
        ...
        if (publicIdToResourceNameMap.keySet().contains(publicId)) {
            final String dtdResourceName =
                    (String) publicIdToResourceNameMap.get(publicId);
